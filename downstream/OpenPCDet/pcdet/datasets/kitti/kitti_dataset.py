...
if __name__ == '__main__':
    ...
    if sys.argv.__len__() > 1 and sys.argv[1] == 'create_kitti_infos':
        ...
        create_kitti_infos(
            ...
            data_path=ROOT_DIR / 'tools' / dataset_cfg.DATA_PATH,
            save_path=ROOT_DIR / 'tools' / dataset_cfg.DATA_PATH
        )
